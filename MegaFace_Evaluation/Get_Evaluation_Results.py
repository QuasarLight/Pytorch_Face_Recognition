...
MODEL = './models/jb_identity.bin'
IDENTIFICATION_EXE = './bin/Identification'
FUSE_RESULTS_EXE = './bin/FuseResults'
MEGAFACE_LIST_BASENAME = './templatelists/megaface_features_list.json'
PROBE_LIST_BASENAME = './templatelists/facescrub_features_list.json'

def main():
    parser = argparse.ArgumentParser(description='Get MegaFace evaluation results with the provided feature files')
    parser.add_argument('--distractor_feature_path',default='/data/face_datasets/test_datasets/face_recognition/MegaFace/megaface_align_112', help='Path to MegaFace Features')
    parser.add_argument('--probe_feature_path',default='/data/face_datasets/test_datasets/face_recognition/MegaFace/facescrub_align_112', help='Path to FaceScrub Features')
    parser.add_argument('--file_ending',default='.feat',help='Ending appended to original photo files')
    parser.add_argument('--out_root',default='/data/face_datasets/test_datasets/face_recognition/MegaFace/results/', help='File output directory, outputs results files, score matrix files, and feature lists used')
    parser.add_argument('-s', '--sizes', type=int, nargs='+',help='(optional) Size(s) of feature list(s) to create. Default: 10 100 1000 10000 100000 1000000')
