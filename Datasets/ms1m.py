...
if __name__ == '__main__':
    dataset_path = '/home/CaiMao/MS1M_112x112/MS1M_112x112'
    file_list = '/home/CaiMao/MS1M_112x112/MS1M-112x112.txt'

    dataset = MS_Celeb_1M(dataset_path, file_list)
    trainloader = DataLoader(dataset, batch_size = 256, shuffle = False, num_workers = 32, drop_last = False, pin_memory = True)
